...
O administrador acessa o aplicativo.

O sistema apresenta a tela principal.

O usuário seleciona uma área de gerenciamento.

O usuário consulta ou cadastra as informações desejadas.

O sistema salva os dados localmente.

Em compras, o estoque é aumentado.

Em vendas, o estoque é reduzido.

Caso ocorra um erro, o sistema apresenta uma mensagem clara ao usuário.
...
Cadastro e gerenciamento de reboques.
...
Login do administrador, se houver tempo.
